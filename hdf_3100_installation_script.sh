...
####################################################################################################################################
#
#   HDF 3.1 Installation (w/ Ambari 2.6.1)
##
...
scp -i ~/.ssh/field.pem centos@dzaratsianhdf0.field.hortonworks.com:/tmp/id_rsa.pub /tmp/.
# Copy the Ambari Host public key into this machine's ~/.ssh/authorized_key file
cat /tmp/id_rsa.pub | ssh centos@dzaratsianhdf1.field.hortonworks.com 'cat >> ~/.ssh/authorized_keys'
cat /tmp/id_rsa.pub | ssh centos@dzaratsianhdf2.field.hortonworks.com 'cat >> ~/.ssh/authorized_keys'
...
#################################################################################################################
#
#   STEP 2: Run on all hosts except for Ambari Host
#
#################################################################################################################
